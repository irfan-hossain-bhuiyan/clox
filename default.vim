...
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit ~/projects/clox/src/table.c
argglobal
balt header/table.h
...
setlocal foldenable
let s:l = 116 - ((27 * winheight(0) + 14) / 28)
...
setlocal foldnestmax=20
setlocal foldenable
let s:l = 30 - ((22 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 30
...
setlocal foldnestmax=20
setlocal foldenable
let s:l = 49 - ((6 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 49
...
edit src/object.c
argglobal
balt ~/projects/clox/src/table.c
setlocal foldmethod=expr
setlocal foldexpr=nvim_treesitter#foldexpr()
setlocal foldmarker={{{,}}}
setlocal foldignore=#
...
setlocal foldnestmax=20
setlocal foldenable
let s:l = 48 - ((13 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 48
...
setlocal foldnestmax=20
setlocal foldenable
let s:l = 72 - ((27 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 72
